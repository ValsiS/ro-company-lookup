...
- Documented CUI digit length requirements and standardized summary payloads.

## [0.3.1] - 2026-01-27

- Added Laravel Boost v2 MCP documentation with skills overview and local setup workflow.
